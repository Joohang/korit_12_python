...
class Student():
    ...
    def show_info(self):
        print(f'학생 이름 : {self.name} \n'
              f'평균 성적 : {student.get_average_grade()}')


student = Student('김일','00001')
student.add_grade(subject='수학',score=90)
student.add_grade(subject='과학',score=60)
student.add_grade(subject='영어',score=80)
