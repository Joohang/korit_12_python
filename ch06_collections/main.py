...
#     print(numbers1)
#
# last_number = int(input('숫자를 입력하세요 >>>'))
# add_numbers1(last_number)
#
# def add_numbers2(n):
#     numbers2 = []
#     for i in range(n):
...
#     return numbers2
#
# print(add_numbers2(last_number))
#
#
...
#
#     for i in range(n):
#         temp_list.insert(i,i+1) # i번지에 i+1값을 더해주니까 0번지에 1더해주고
#     print(temp_list)
#
#
#
...
def count_even_odd(numbers):
    ...
    if n%2==0:
        num_of_even = n//2
        num_of_odd = n//2
        print(f'짝수의 개수 : {num_of_even}')
        print(f'홀수의 개수 : {num_of_odd}')
    else :
        num_of_even = n//2
        num_of_odd = (n//2) + 1
        print(f'짝수의 개수 : {num_of_even}')
...
count_even_odd([ 2, 3, 4, 5, 6, 7, 8, 9])
